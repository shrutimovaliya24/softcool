...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (!hasSignedUp) {
      // User hasn't signed up - redirect to signup page immediately
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg">
          ...
          <p className="text-left text-[#0D031A] mb-6 font-sans">
            New to this site?{' '}
            <Link href="/signup" className="text-[#5298C1] hover:text-[#FDF55A] font-semibold transition-colors">
              Sign Up
            </Link>
          </p>
          ...
          <div>
            ...
            >
              ...
              <span className="group-hover:text-white">Log in with Google</span>
            </button>
          </div>
        </div>
      </div>
